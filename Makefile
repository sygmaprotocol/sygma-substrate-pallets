...
# setup-subbridge-e2e-test clone and build the polkadot relay chain and khala parachain nodes
...
# setup-prebuild-subbridge-e2e-test is trying to use the prebuild relay chain node binary from polkadot
# only use this cmd when your OS is Linux
setup-prebuild-subbridge-e2e-test:
	./scripts/phala-subbridge/e2e_prebuild_launch.sh
	./scripts/phala-subbridge/e2e_setup.sh

# build-subbridge-e2e-test-docker-image builds the e2e test docker image using the chain data generated by setup-subbridge-e2e-test
