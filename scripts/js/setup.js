...
const mpcPubKey = '111111111111111111111111111111111'; // TODO: replace mpc key with the actual one from relayer
...
async function main() {
    ...
    await configSygmaPallet(api, bn1e12.mul(new BN(basicFee)), true, sudo);
}
