...
async function testcase1(bridgeHubApi, sudo, failedTestcases) {
    ...
    await depositLocal(bridgeHubApi, getNativeMultiAsset(bridgeHubApi, depositAmount), getAssetDepositDest(bridgeHubApi), true, sudo)
...
async function testcase2(bridgeHubApi, sudo, failedTestcases) {
    ...
    await depositLocal(bridgeHubApi, getUSDCMultiAsset(bridgeHubApi, usdcDepositAmount), getAssetDepositDest(bridgeHubApi), true, sudo)
