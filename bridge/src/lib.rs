...
pub mod pallet {
    ...
    use frame_support::{
        ...
        pallet_prelude::*,
        PalletId,
        traits::{ContainsPair, StorageVersion}, transactional,
    };
    ...
    mod test {
        ...
        use primitive_types::U256;
        use sp_core::{ByteArray, ecdsa, Pair};
        use sp_std::{boxed::Box, vec};
        use xcm::latest::prelude::*;

        use bridge::mock::{
            AccessSegregator, ALICE, assert_events, ASSET_OWNER, Assets, Balances,
            BOB, BridgeAccountNative, BridgeAccountOtherTokens, BridgePalletIndex,
            DEST_DOMAIN_ID, ENDOWED_BALANCE, NativeLocation, NativeResourceId, new_test_ext,
            Runtime, RuntimeEvent, RuntimeOrigin as Origin, slice_to_generalkey,
            SygmaBasicFeeHandler, SygmaBridge, SygmaFeeHandlerRouter, SygmaPercentageFeeHandler, TreasuryAccount, UsdtAssetId, UsdtLocation,
            UsdtResourceId,
        };
        ...
        use crate::{
            DestChainIds,
            DestDomainIds, Error, Event as SygmaBridgeEvent, IsPaused, mock::{AstrAssetId, AstrLocation, AstrResourceId}, MpcAddr,
            Proposal,
        };
